...
;; ~/.emacs.d/emacs-registers
(defvar emacs-registers (expand-file-name "emacs-registers" emacs-dir)
...
(custom-set-variables
 ...
 '(package-selected-packages (quote (flx-ido ido-ubiquitous smex autopair))))
(custom-set-faces
